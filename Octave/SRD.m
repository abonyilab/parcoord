%% Written by János Abonyi and Ádám Ipkovich, 10.10.2021
...
function [srdi, srdindex, srdmat, srdlabels, srd_ranked_data] = SRD(data, g, axesnames, goldenname, stdcheck)
R = tiedrank(data)
...
srdmat = [];
for j =1:n+1
     srdmat =[srdmat; sum(abs(orderedR - orderedR(:, j)), 1)];
end
