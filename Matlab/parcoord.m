%% Parallel coordinates visualization. Written by János Abony and Ádám Ipkovich, 10.10.2021 (ddmmyyyy)
...
tau = corr(coord, 'type', 'Kendall');
intersections = [];
for j =2:n
    intersections = [intersections, ((1-tau(j, j-1))).*(N*(N-1))/4]; 
end
