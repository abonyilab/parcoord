%% Demo for the SRD based parallel coordinates. Written by János Abonyi and Ádám Ipkovich, 10.10.2021 (ddmmyyyy)
clear all
close all
clc
...
[srdi, srdindex, srdmat, srdlabels, srd_ranked_data, dist] = SRD(u, golden, axesnames, string(climate_data.Properties.VariableNames(15)), true);
figure(2)
...
figure(4)
parcoord_srd_angle(u, golden, axesnames, string(climate_data.Properties.VariableNames(15)));
